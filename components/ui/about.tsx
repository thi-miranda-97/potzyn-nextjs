...
export default function About() {
  return (
    <section className="w-full bg-accent p-3 lg:p-6 rounded-lg shadow-sm">
      ...
      <div className=" w-[90%] mx-auto grid grid-cols-2 md:grid-cols-4 gap-3 lg:gap-6">
        <div className="flex flex-col border-r-2 pr-1 lg:pr-2 h-full ">
        ...
        <div className="flex flex-col border-r-2 md:border-none pr-1 lg:pr-2 h-full">
          <p className="body-1 font-medium mb-1 lg:mb-2 flex gap-1 lg:gap-2">
            <span>
              <RedeemOutlinedIcon />
            </span>
